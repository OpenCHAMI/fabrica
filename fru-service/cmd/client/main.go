...
import (
	...
	"github.com/openchami/fru-service/pkg/client"
...
Examples:
  # Create from stdin
  echo '{"fruType": "example-value", "serialNumber": "example-value", "partNumber": "example-value", "manufacturer": "example-value", "model": "example-value", "description": "Example description", "version": "example-value", "firmwareVersion": "example-value", "parent": "example-value", "children": ["["item1","item2"]"], "location": "{}", "redfishPath": "example-value", "properties": {"key":"value"}}' | client fru create

  # Create with --spec flag
  client fru create --spec '{"fruType": "example-value", "serialNumber": "example-value", "partNumber": "example-value", "manufacturer": "example-value", "model": "example-value", "description": "Example description", "version": "example-value", "firmwareVersion": "example-value", "parent": "example-value", "children": ["["item1","item2"]"], "location": "{}", "redfishPath": "example-value", "properties": {"key":"value"}}'

Spec fields:
  fruType (string) [required]
  serialNumber (string)
  partNumber (string)
  manufacturer (string)
  model (string)
...
Examples:
  # Update from stdin
  echo '{"fruType": "example-value", "serialNumber": "example-value", "partNumber": "example-value", "manufacturer": "example-value", "model": "example-value", "description": "Example description", "version": "example-value", "firmwareVersion": "example-value", "parent": "example-value", "children": ["["item1","item2"]"], "location": "{}", "redfishPath": "example-value", "properties": {"key":"value"}}' | client fru update <uid>

  # Update with --spec flag
  client fru update <uid> --spec '{"fruType": "example-value", "serialNumber": "example-value", "partNumber": "example-value", "manufacturer": "example-value", "model": "example-value", "description": "Example description", "version": "example-value", "firmwareVersion": "example-value", "parent": "example-value", "children": ["["item1","item2"]"], "location": "{}", "redfishPath": "example-value", "properties": {"key":"value"}}'
